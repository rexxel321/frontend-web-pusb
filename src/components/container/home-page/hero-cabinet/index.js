  ...
  return (
    <section className="w-full min-h-[35vh] bg-vox-green/10 border-y border-vox-green/20">
      <div className="w-full h-full px-4 lg:px-16 py-10 mx-auto max-w-screen-xl">
        <div className="w-full h-full lg:flex lg:justify-center lg:items-center gap-10">
          {/* Image */}
          <div className="w-full max-w-xs flex justify-center mb-6 lg:mb-0">
            <img
          ...
          {/* Content */}
          <div className="w-full lg:flex lg:flex-col lg:justify-center px-2">
            {/* Title with side lines */}
            <p className="text-xl lg:text-3xl font-display tracking-widest text-vox-cream flex items-center gap-4">
            ...
            {/* Button */}
            <div className="w-full text-center lg:text-left py-5">
